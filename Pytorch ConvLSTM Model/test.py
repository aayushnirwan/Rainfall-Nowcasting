...
### loading validation dataset
    print ("Model - {} Loaded".format(idx))
    self_built_dataset = util.Dataloader0(args.data_dir+args.val_name,
                                          args.seq_start,
    ...
    trainloader = DataLoader(
        ...
        drop_last=True)
    # c=0
    for iteration,valid_data in tqdm(enumerate(trainloader,0)):
...
if __name__== "__main__":
    ...
    x = int(input("Enter model number"))
    test(x,None,reload=True)
