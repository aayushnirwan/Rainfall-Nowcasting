...
train_input = np.load('train_sequences_400_sm.npy')
train_label = np.load('train_labels_400_sm.npy')
val_input = np.load('val_sequences_400_sm.npy')
val_label = np.load('val_labels_400_sm.npy')
